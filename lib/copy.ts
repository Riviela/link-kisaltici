...
export const copy = {
  ...
  pricing: {
    ...
    plans: {
      starter: {
        ...
        features: [
          "Your own Canvas Links",
          "Basic analytics",
          "Digital product sales (9% fee)",
        ],
      },
      pro: {
        name: "Pro",
      ...
      premium: {
        ...
        features: [
          ...
          "Digital product sales (0% fee)",
          "Canvas Links affiliate store (keep 100%)",
  ...
  socialProfiles: {
    title: "Social icons",
    description: "Show visitors where to find you",
    body: "Add your social profiles, email and more as linked icons on your Canvas Links.",
    positionTitle: "Social icon position",
    positionDescription: "Display icons at the top or bottom of your profile",
    top: "Top",
    bottom: "Bottom",
    insights: "See insights",
    addSocialIcon: "Add social icon",
    addIconTitle: "Add social icon",
      search: "Search",
      addProviderIcon: (platform: string) => `Add ${platform} icon`,
      editProviderIcon: (platform: string) => `Edit ${platform} icon`,
      ...
      back: "Back",
    saving: "Saving...",
    success: "Your social icons were updated.",
    failure: {
      authentication: "Your session has expired. Please log in again.",
